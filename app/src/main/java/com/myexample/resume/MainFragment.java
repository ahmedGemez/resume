...
public class MainFragment extends Fragment implements ResumesAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton edit=rootView.findViewById(R.id.add);
            ...
            public void onClick(View view) {
                NavDirections action =
                        MainFragmentDirections
                                .actionMainFragmentToEditDataFragment();
                Navigation.findNavController(view).navigate(action);
            }
        });

        RecyclerView recyclerView = rootView.findViewById(R.id.recyclerview);
        resumesAdapter = new ResumesAdapter(this.getActivity(),this);
        recyclerView.setAdapter(resumesAdapter);
        ...
        personalDataViewModel.getAllPersonalData().observe(this, new Observer<List<PersonalDataModel>>() {
            ...
            public void onChanged(@Nullable List<PersonalDataModel> personalDataModels) {
                resumesAdapter.setPersonalDataModel(personalDataModels);
            }
        });
    ...
    public void onItemClick(int id,View view) {
        Log.d("svlnvn",id+"d,ncmdn");
        Bundle bundle=new Bundle();
        bundle.putInt("id",id);
        ViewFragmentArgs action =
                ViewFragmentArgs.fromBundle(bundle);
